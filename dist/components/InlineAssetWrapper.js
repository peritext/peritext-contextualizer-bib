...
const InlineAssetWrapper = ({
  ...
  if (contextualizer && Component) {
    ...
    if (contextualizer.type === 'glossary') {
      return useGlossary ? _react.default.createElement("a", {
    ...
    return _react.default.createElement("span", {
      ...
      renderingMode: 'paged',
      assets: assets
    }, ['image', 'embed'].includes(contextualizer.type) ? _react.default.createElement("span", {
      style: {
        display: 'none'
      }
    }, children) : children), figuresPosition !== 'inBody' && ['image', 'embed'].includes(contextualizer.type) ? ')' : null);
  }
