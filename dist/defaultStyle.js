...
.figures-list .end-figure-container figure:not(.table):not(.vegaLite) figcaption {
  padding-left: 1rem;
  padding-right: 1rem;
}
 ...
 */
.figures-list .end-figure-container figure.column {
  flex-direction: column!important;
}
.figures-list .end-figure-container figure.column:not(.table) figcaption {
  max-width: 100%!important;
}
.figures-list .end-figure-container figure.absolute {
  position: absolute!important;
}
.figures-list .end-figure-container figure.absolute.top {
  top: 0!important;
}
.figures-list .end-figure-container figure.absolute.left {
  left: 0!important;
}
.figures-list .end-figure-container figure.absolute.right {
  right: 0!important;
}
.figures-list .end-figure-container figure.big-height img {
  max-height: unset;
}
.figures-list .end-figure-container figure.big-width img {
  max-width: unset;
}
